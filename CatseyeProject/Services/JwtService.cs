...
namespace CatseyeProject.Services
{
    public class JwtService : IJwtService
    {
        ...
        {
            var user = _context.tblAppUsers.FirstOrDefault(x => x.UserName.Equals(authRequest.UserName)
        ...
        private async Task<AuthResponse> SaveTokenDetails(string ipAddress, int userId, string tokenString, string refreshToken)
        {
            ...
            await _context.tblUserRefreshTokens.AddAsync(userRefreshToken);
        ...
        {
            var isValid = _context.tblUserRefreshTokens.FirstOrDefault(x => x.Token == accessToken
